...
CallSite extends Struct implements Powerless, Record, Serializable {
     ...
     * start of the span and the second row is the end of the span. Each row
     * lists the line number followed by the column number. For example, a span
     * of code starting on line 5, column 8 and ending on line 6, column 12 is
     * encoded as:
     * </p>
     * <p><code>[ [ 5, 8 ], [ 6, 12 ] ]</code></p>
     * <p>
