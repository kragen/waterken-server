...
HTTPD extends TCPDaemon {
    ...
    accept(final String hostname, final Socket socket) {
        ...
        return new ServerSide(this, location, socket);
    }
    ...
    readHeaders(final LineInput hin) throws Exception {
        PowerlessArray.Builder<Header> r = PowerlessArray.builder();
        ...
        while (!"".equals(line)) {
            ...
            r.append(new Header(name, value));
        }
        return r.snapshot();
    }
    ...
    forward(final String version, final PowerlessArray<Header> headers,
        ...
        PowerlessArray.Builder<Header> retained = PowerlessArray.builder();
        ...
        PowerlessArray<Header> r = retained.snapshot();
